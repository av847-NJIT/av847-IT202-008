...
*/
$query = "SELECT id, task, due, Date(completed) AS completed, DATEDIFF(due, DATE(completed)) AS days_offset, assigned, FROM M4_Todos WHERE is_complete = 1 ORDER BY completed DESC, due DESC"; // edit this
$results = [];
try {
